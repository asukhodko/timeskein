...
pub enum AppEventKind {
    ...
    DayContractCreated,
    DayContractRevised,
    DayContractStartRequested,
    DayContractStarted,
    DayContractStartFailed,
    DayContractReentryReviewed,
    ReportCopyRequested,
    ReportCopied,
    ReportCopyFailed,
    ...
    ReentryStarted,
    WorkItemMerged,
    DayContractOutcomeRecorded,
    DayContractOverflowRecorded,
    ApiError,
}
...
impl AppEventKind {
    pub fn from_str(value: &str) -> Option<Self> {
        match value {
            ...
            "day_contract_created" => Some(Self::DayContractCreated),
            "day_contract_revised" => Some(Self::DayContractRevised),
            "day_contract_start_requested" => Some(Self::DayContractStartRequested),
            "day_contract_started" => Some(Self::DayContractStarted),
            "day_contract_start_failed" => Some(Self::DayContractStartFailed),
            "day_contract_reentry_reviewed" => Some(Self::DayContractReentryReviewed),
            ...
            "day_context_reviewed" => Some(Self::DayContextReviewed),
            "work_item_time_badges_reviewed" => Some(Self::WorkItemTimeBadgesReviewed),
            "activity_zone_glanced" => Some(Self::ActivityZoneGlanced),
            ...
            "working_memory_opened" => Some(Self::WorkingMemoryOpened),
            "working_memory_created" => Some(Self::WorkingMemoryCreated),
            "working_memory_updated" => Some(Self::WorkingMemoryUpdated),
            "working_memory_deleted" => Some(Self::WorkingMemoryDeleted),
            "work_item_stage_changed" => Some(Self::WorkItemStageChanged),
            "context_pack_built" => Some(Self::ContextPackBuilt),
            "context_pack_exported" => Some(Self::ContextPackExported),
            "reentry_started" => Some(Self::ReentryStarted),
            "work_item_merged" => Some(Self::WorkItemMerged),
            "day_contract_outcome_recorded" => Some(Self::DayContractOutcomeRecorded),
            "day_contract_overflow_recorded" => Some(Self::DayContractOverflowRecorded),
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::DayContractCreated => "day_contract_created",
            Self::DayContractRevised => "day_contract_revised",
            Self::DayContractStartRequested => "day_contract_start_requested",
            Self::DayContractStarted => "day_contract_started",
            Self::DayContractStartFailed => "day_contract_start_failed",
            Self::DayContractReentryReviewed => "day_contract_reentry_reviewed",
            ...
            Self::DayContextReviewed => "day_context_reviewed",
            Self::WorkItemTimeBadgesReviewed => "work_item_time_badges_reviewed",
            Self::ActivityZoneGlanced => "activity_zone_glanced",
            ...
            Self::WorkingMemoryOpened => "working_memory_opened",
            Self::WorkingMemoryCreated => "working_memory_created",
            Self::WorkingMemoryUpdated => "working_memory_updated",
            Self::WorkingMemoryDeleted => "working_memory_deleted",
            Self::WorkItemStageChanged => "work_item_stage_changed",
            Self::ContextPackBuilt => "context_pack_built",
            Self::ContextPackExported => "context_pack_exported",
            Self::ReentryStarted => "reentry_started",
            Self::WorkItemMerged => "work_item_merged",
            Self::DayContractOutcomeRecorded => "day_contract_outcome_recorded",
            Self::DayContractOverflowRecorded => "day_contract_overflow_recorded",
