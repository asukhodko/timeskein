    ...
    >
      ...
      >
        <div className="mb-4 flex items-start justify-between gap-3">
          <div>
            <div className="text-lg font-semibold text-gray-100">Add Focus Block</div>
            <div className="text-xs text-gray-500">Post-factum correction</div>
          </div>
        ...
        {createMutation.error && (
          <div className="mt-3 text-xs text-red-300">
            {createMutation.error instanceof Error ? createMutation.error.message : 'Block creation failed'}
          </div>
        )}
