...
**Исторический**. Текущий исполняемый roadmap ведётся в
[opskarta.md](opskarta.md) и исходных v3-файлах `plans/timeskein/*.plan.yaml`.

Этот документ оставлен как контекст по первоначальному MVP-плану Manual-first
Inventory.
