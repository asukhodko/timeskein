...
The roadmap now backcasts from one north star: a local causal work memory that
connects intention, episode, context, change, evidence, decision, and next
action. Work is ordered by user value and early risk reduction.
...
| [0005-causal-work-memory-roadmap.md](0005-causal-work-memory-roadmap.md) | Strategic / Level 0+ to Level 3 | Current route from accepted manual foundation to causal steering, context fabric, private intelligence, continuity, and opt-in Full Context |
