...
function summarizeEvents(events) {
  ...
  return {
    ...
    dispatchRitualEntryRequests: countEntryRequestsByControls(events, ["dispatch_ritual", "day_contract"]),
    ...
    dayContractStarts: count("day_contract_started"),
    dayContractStartFailures: count("day_contract_start_failed"),
    dayContractReentries: count("day_contract_reentry_reviewed"),
