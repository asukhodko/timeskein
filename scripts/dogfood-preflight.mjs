...
const steps = [
  ...
  ["node", ["--check", "scripts/reflection-session.mjs"]],
  ["node", ["--check", "scripts/evidence-story-gate.mjs"]],
  ...
  ["node", ["--check", "scripts/context-pack.mjs"]],
  ["node", ["--check", "scripts/working-memory-gate.mjs"]],
  ...
  ["node", ["--check", "scripts/smoke-reflection-session.mjs"]],
  ["node", ["--check", "scripts/smoke-semantic-api.mjs"]],
  ["node", ["--check", "scripts/smoke-evidence-api.mjs"]],
