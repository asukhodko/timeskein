...
try {
  ...
  const rcAuditRows = [
    "| Финальное состояние чистое | ок | 0 активных фокус-сессий, 0 дел со статусом active |",
    "| Фокус-блоки видны | ок | 3 входа, 2:00 учтено |",
    "| Итоги по делам есть | ок | 2 строки итогов дел, 1 проверка времени в UI |",
    "| Зоны активности разделены | ок | 2 зоны, 1:30 работа, 0:30 вне работы |",
    "| Контекст дня и дел сохранён | ок | 1 событий дня, 1 событий дел, 1 заметок дел |",
    ...
    "| Красных пунктов нет | ок | 0 красных пунктов |",
